    ...
    <section id="galeria" className="py-24 md:py-32 bg-[#FAF6F0] dark:bg-[#2B1A0F] transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mt-8">
          <a href="https://www.instagram.com/massas100caseiras/" target="_blank" rel="noopener noreferrer" onClick={() => trackInstagramClick('gallery')} className="inline-flex items-center gap-1.5 text-[#8C7B6B] text-sm font-[family-name:var(--font-sans)] hover:text-[#A0301A] transition-colors">
